...
import { Trash, Eye, Search, User, Home, Phone, Mail, FileText, Hash, DollarSign, FunctionSquare, CheckSquare, Radio, Image, Upload } from "lucide-react";
      ...
      <div className="form-builder">
        ...
        <div className="form-container1">
          ...
          {formFields.map((field) => (
            <div key={field.id} className="form-field1">
